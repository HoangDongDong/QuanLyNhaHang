    ...
    public static class DbFormService
    {
        ...
        public static Form CreateFormByName(string formName)
        {
            try
            {
                ...
                // 1b. Prioritize compiled QuanLyBanHangNhaHang ("Quản lý bán hàng") form directly
                if (string.Equals(formName, "Quản lý bán hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Quản lý bán hàng nhà hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "QuanLyBanHangNhaHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "QuanLyBanHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Điều chỉnh hóa đơn", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "DieuChinhHoaDon", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "417e6d1d-ed16-4847-b752-65c3cefbe341", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("Quản lý bán hàng", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("QuanLyBanHang", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("Điều chỉnh hóa đơn", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("DieuChinhHoaDon", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Quản lý bán hàng") ?? GetFormModelFromDb("Quản lý bán hàng nhà hàng");
                    return CreateDynamicQuanLyBanHangForm(m);
                }

                // 1c. Prioritize compiled ThongKeDoanhThu ("Thống kê doanh thu") form directly
                if (string.Equals(formName, "Thống kê doanh thu", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "ThongKeDoanhThu", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "d913c8d9-4395-476c-9612-8ca7f35b6268", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("Thống kê doanh thu", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("ThongKeDoanhThu", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Thống kê doanh thu") ?? GetFormModelFromDb("d913c8d9-4395-476c-9612-8ca7f35b6268");
                    return CreateDynamicThongKeDoanhThuForm(m);
                }

                // 1d. Prioritize compiled TheoDoiDatPhong ("Theo dõi đặt phòng") form directly
                if (string.Equals(formName, "Theo dõi đặt phòng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Theo doi dat phong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "TheoDoiDatPhong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "11f4bf28-9dd4-4a22-8c5c-e912a637576a", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("đặt phòng", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("dat phong", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("TheoDoiDatPhong", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Theo dõi đặt phòng") ?? GetFormModelFromDb("11f4bf28-9dd4-4a22-8c5c-e912a637576a");
                    return CreateDynamicTheoDoiDatPhongForm(m);
                }

                // 1e. Prioritize compiled ThongKeMatHangBan ("Thống kê mặt hàng bán") form directly
                if (string.Equals(formName, "Thống kê mặt hàng bán", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "ThongKeMatHangBan", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "67500401-1f1e-4c18-a0fc-f487c43f4b0c", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("mặt hàng bán", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("mat hang ban", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("ThongKeMatHangBan", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Thống kê mặt hàng bán") ?? GetFormModelFromDb("67500401-1f1e-4c18-a0fc-f487c43f4b0c");
                    return CreateDynamicThongKeMatHangBanForm(m);
                }

                // 1f. Prioritize compiled LuuVetHoatDong ("Lưu vết hoạt động") form directly
                if (string.Equals(formName, "Lưu vết hoạt động", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Luu vet hoat dong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "LuuVetHoatDong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "ac206bb6-0236-48a6-b558-b674e015c21c", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("lưu vết", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("luu vet", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("LuuVetHoatDong", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Lưu vết hoạt động") ?? GetFormModelFromDb("ac206bb6-0236-48a6-b558-b674e015c21c");
                    return CreateDynamicLuuVetHoatDongForm(m);
                }

                // 1g. Prioritize compiled KiemSoatOrder ("Kiểm soát order") form directly
                if (string.Equals(formName, "Kiểm soát order", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Kiem soat order", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "KiemSoatOrder", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "8cb6cbb8-5303-4425-a086-7e8280a4cb3e", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("kiểm soát order", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("kiem soat order", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("KiemSoatOrder", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Kiểm soát order") ?? GetFormModelFromDb("8cb6cbb8-5303-4425-a086-7e8280a4cb3e");
                    return CreateDynamicKiemSoatOrderForm(m);
                }

                // 1h. Prioritize compiled DanhSachBillHuy ("Danh mục hóa đơn hủy" / "Danh sách bill hủy") form directly
                if (string.Equals(formName, "Danh mục hóa đơn hủy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc hoa don huy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh sách hóa đơn hủy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh sach hoa don huy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh sách bill hủy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh sach bill huy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "DanhSachBillHuy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "a52478cf-2d23-4ff0-8b63-e098e5ce6829", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        formName.IndexOf("hóa đơn hủy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("hoa don huy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("bill hủy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("bill huy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        formName.IndexOf("DanhSachBillHuy", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Danh mục hóa đơn hủy") ?? GetFormModelFromDb("a52478cf-2d23-4ff0-8b63-e098e5ce6829");
                    return CreateDynamicDanhSachBillHuyForm(m);
                }

                // 1i. Prioritize compiled KhachHangThanThiet ("Khách hàng thân thiết") form directly
                if (string.Equals(formName, "Khách hàng thân thiết", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Khach hang than thiet", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "KhachHangThanThiet", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "10e06969-754e-404a-9ea4-1f0d4574ddb7", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(formName) && (
                        ...
                        formName.IndexOf("KhachHangThanThiet", StringComparison.OrdinalIgnoreCase) >= 0
                    )))
                {
                    FormModel m = GetFormModelFromDb(formName) ?? GetFormModelFromDb("Khách hàng thân thiết") ?? GetFormModelFromDb("10e06969-754e-404a-9ea4-1f0d4574ddb7");
                    return CreateDynamicKhachHangThanThietForm(m);
                }

                // 1j. Prioritize compiled DanhMucMatHang ("Danh mục mặt hàng" / "DMATHANG") form directly
                if (string.Equals(formName, "Danh mục mặt hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc mat hang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Nhóm mặt hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Nhom mat hang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Mặt hàng", StringComparison.OrdinalIgnoreCase) ||
                ...
                {
                    return new Forms.DanhMucMatHang();
                }

                // 1k. Prioritize compiled DanhMucBanKhuVuc ("Danh mục bàn khu vực" / "DBAN" / "DKHUVUC") form directly
                if (string.Equals(formName, "Danh mục bàn khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc ban khu vuc", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh mục bàn, khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh mục khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc khu vuc", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Bàn khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Bàn", StringComparison.OrdinalIgnoreCase) ||
                ...
                {
                    return new Forms.DanhMucBanKhuVuc();
                }

                // 1l. Prioritize compiled DanhMucKhachHang ("Danh mục khách hàng" / "DKHACHHANG") form directly
                if (string.Equals(formName, "Danh mục khách hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc khach hang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Nhóm khách hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Nhom khach hang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Khách hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Khach hang", StringComparison.OrdinalIgnoreCase) ||
                ...
                {
                    return new Forms.DanhMucKhachHang();
                }

                // 1m. Prioritize compiled DanhMucDotKhuyenMai ("Danh mục đợt khuyến mại" / "DDOTKHUYENMAI") form directly
                if (string.Equals(formName, "Danh mục đợt khuyến mại", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Danh muc dot khuyen mai", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Đợt khuyến mại", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Dot khuyen mai", StringComparison.OrdinalIgnoreCase) ||
                    ...
                    (!string.IsNullOrEmpty(formName) && (
                        ...
                        formName.IndexOf("canh bao", StringComparison.OrdinalIgnoreCase) < 0 && (
                            ...
                            formName.IndexOf("loại hình khuyến mại", StringComparison.OrdinalIgnoreCase) >= 0 ||
                            formName.IndexOf("loai hinh khuyen mai", StringComparison.OrdinalIgnoreCase) >= 0 ||
                ...
                {
                    return new Forms.DanhMucDotKhuyenMai();
                }

                // 1n. Prioritize compiled FormThemNhanhBan ("Thêm nhanh bàn" / "ff770199-3cfe-42de-aef2-5f19ff7eba10") form directly
                if (string.Equals(formName, "Thêm nhanh bàn", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Them nhanh ban", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "THÊM NHANH BÀN VÀ KHU VỰC", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "ThemNhanhBan", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "FormThemNhanhBan", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "ff770199-3cfe-42de-aef2-5f19ff7eba10", StringComparison.OrdinalIgnoreCase))
                {
                    return new Forms.FormThemNhanhBan();
                }
                ...
                if (model != null && (
                    string.Equals(model.ClassName, "QuanLyBanHangNhaHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.ClassName, "QuanLyBanHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Quản lý bán hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Quản lý bán hàng nhà hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "417e6d1d-ed16-4847-b752-65c3cefbe341", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicQuanLyBanHangForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "ThongKeDoanhThu", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Thống kê doanh thu", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "d913c8d9-4395-476c-9612-8ca7f35b6268", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicThongKeDoanhThuForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "TheoDoiDatPhong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Theo dõi đặt phòng", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("đặt phòng", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("dat phong", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "11f4bf28-9dd4-4a22-8c5c-e912a637576a", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicTheoDoiDatPhongForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "ThongKeMatHangBan", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Thống kê mặt hàng bán", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("mặt hàng bán", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("mat hang ban", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "67500401-1f1e-4c18-a0fc-f487c43f4b0c", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicThongKeMatHangBanForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "LuuVetHoatDong", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Lưu vết hoạt động", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("lưu vết", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("luu vet", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "ac206bb6-0236-48a6-b558-b674e015c21c", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicLuuVetHoatDongForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "KiemSoatOrder", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Kiểm soát order", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("kiểm soát order", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("kiem soat order", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "8cb6cbb8-5303-4425-a086-7e8280a4cb3e", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicKiemSoatOrderForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "DanhSachBillHuy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục hóa đơn hủy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh sách hóa đơn hủy", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh sách bill hủy", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("hóa đơn hủy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("hoa don huy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("bill hủy", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("bill huy", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "a52478cf-2d23-4ff0-8b63-e098e5ce6829", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicDanhSachBillHuyForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "KhachHangThanThiet", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Khách hàng thân thiết", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("thân thiết", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("than thiet", StringComparison.OrdinalIgnoreCase) >= 0
                    )) ||
                    string.Equals(model.Id, "10e06969-754e-404a-9ea4-1f0d4574ddb7", StringComparison.OrdinalIgnoreCase)))
                {
                    return CreateDynamicKhachHangThanThietForm(model);
                }

                if (model != null && (
                    string.Equals(model.ClassName, "DanhMucMatHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục mặt hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Nhóm mặt hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "f3784a00-a86f-44d6-86b8-01187cc1a5e2", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.STableDescId, "a4a16216-aee9-4dd3-9f92-c1e4d85c06a2", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("mặt hàng", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("mat hang", StringComparison.OrdinalIgnoreCase) >= 0
                    ))))
                {
                    return new Forms.DanhMucMatHang();
                }
                ...
                if (model != null && (
                    string.Equals(model.ClassName, "DanhMucBanKhuVuc", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.ClassName, "DanhMucKhuVuc", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục bàn khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục bàn, khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Khu vực", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "756598f2-e672-4c0f-b6a8-d7d514feb5be", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.STableDescId, "f2288345-031a-4e1b-a76d-3b2e537674a6", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.STableDescId, "9e2afcb8-7f63-4123-b0f7-c32cc187dd65", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("bàn khu vực", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("ban khu vuc", StringComparison.OrdinalIgnoreCase) >= 0 ||
                        model.Name.IndexOf("b?n khu", StringComparison.OrdinalIgnoreCase) >= 0
                    ))))
                {
                    return new Forms.DanhMucBanKhuVuc();
                }
                ...
                if (model != null && (
                    string.Equals(model.ClassName, "DanhMucKhachHang", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục khách hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Nhóm khách hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "f5093034-07a8-41a3-8561-7864cbab2d2e", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.STableDescId, "5fcc571a-662d-4953-a83f-6004c732f439", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("thân thiết", StringComparison.OrdinalIgnoreCase) < 0 &&
                        model.Name.IndexOf("than thiet", StringComparison.OrdinalIgnoreCase) < 0 && (
                            model.Name.IndexOf("khách hàng", StringComparison.OrdinalIgnoreCase) >= 0 ||
                            model.Name.IndexOf("khach hang", StringComparison.OrdinalIgnoreCase) >= 0
                        )
                    ))))
                {
                    return new Forms.DanhMucKhachHang();
                ...
                if (model != null && (
                    string.Equals(model.ClassName, "DanhMucDotKhuyenMai", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Danh mục đợt khuyến mại", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Đợt khuyến mại", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "e1bfaa55-e880-4835-94e4-b98443ded684", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.STableDescId, "1732f45e-07ab-46ff-9489-66273cdb8eda", StringComparison.OrdinalIgnoreCase) ||
                    (!string.IsNullOrEmpty(model.Name) && (
                        model.Name.IndexOf("cảnh báo", StringComparison.OrdinalIgnoreCase) < 0 &&
                        model.Name.IndexOf("canh bao", StringComparison.OrdinalIgnoreCase) < 0 && (
                            model.Name.IndexOf("đợt khuyến mại", StringComparison.OrdinalIgnoreCase) >= 0 ||
                            model.Name.IndexOf("dot khuyen mai", StringComparison.OrdinalIgnoreCase) >= 0 ||
                            model.Name.IndexOf("khuyến mại", StringComparison.OrdinalIgnoreCase) >= 0 ||
                            model.Name.IndexOf("khuyen mai", StringComparison.OrdinalIgnoreCase) >= 0
                        )
                    ))))
                {
                    return new Forms.DanhMucDotKhuyenMai();
                ...
                if (model != null && (
                    string.Equals(model.ClassName, "ThemNhanhBan", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Name, "Thêm nhanh bàn", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(model.Id, "ff770199-3cfe-42de-aef2-5f19ff7eba10", StringComparison.OrdinalIgnoreCase)))
                {
                    return new Forms.FormThemNhanhBan();
                }
                ...
                if (string.Equals(formName, "Danh mục kho hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "Kho hàng", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "DKHOHANG", StringComparison.OrdinalIgnoreCase) ||
                    string.Equals(formName, "aad0140d-3805-490a-9698-6a947b1f8af5", StringComparison.OrdinalIgnoreCase))
                {
                    return new No1Lib.Sys.TreeDataMg(null, "DKHOHANG");
                }
        ...
        private static Form CreateDynamicQuanLyBanHangForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Quản lý bán hàng nhà hàng",
                Size = new Size(1024, 600),
                BackColor = System.Drawing.Color.White,
                WindowState = FormWindowState.Normal
            };
            ...
            try
            {
                No1Run.QuanLyBanHangNhaHang qlbh = new No1Run.QuanLyBanHangNhaHang();
                qlbh.Dock = DockStyle.Fill;
                form.Controls.Add(qlbh);
                qlbh.No1UserControl1_OnInit(qlbh, EventArgs.Empty);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine("Error creating QuanLyBanHangNhaHang: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicThongKeDoanhThuForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Thống kê doanh thu",
            ...
            try
            {
                No1Run.ThongKeDoanhThu tkdt = new No1Run.ThongKeDoanhThu();
                tkdt.Dock = DockStyle.Fill;
                form.Controls.Add(tkdt);
            }
            catch (Exception ex)
            {
                System.Diagnostics.Debug.WriteLine("Error creating ThongKeDoanhThu: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicTheoDoiDatPhongForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Theo dõi đặt phòng",
                Size = new Size(1040, 600),
            ...
            try
            {
                No1Run.TheoDoiDatPhong tddp = new No1Run.TheoDoiDatPhong();
                tddp.Dock = DockStyle.Fill;
                form.Controls.Add(tddp);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error creating TheoDoiDatPhong: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating TheoDoiDatPhong: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicThongKeMatHangBanForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Thống kê mặt hàng bán",
                Size = new Size(1040, 600),
                BackColor = System.Drawing.Color.White,
                StartPosition = FormStartPosition.CenterScreen,
                WindowState = FormWindowState.Normal
            ...
            try
            {
                No1Run.ThongKeMatHangBan tkmhb = new No1Run.ThongKeMatHangBan();
                tkmhb.Dock = DockStyle.Fill;
                form.Controls.Add(tkmhb);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error creating ThongKeMatHangBan: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating ThongKeMatHangBan: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicLuuVetHoatDongForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Lưu vết hoạt động",
                Size = new Size(1040, 600),
                BackColor = System.Drawing.Color.White,
                StartPosition = FormStartPosition.CenterScreen,
                WindowState = FormWindowState.Normal
            ...
            try
            {
                No1Run.LuuVetHoatDong lvhd = new No1Run.LuuVetHoatDong();
                lvhd.Dock = DockStyle.Fill;
                form.Controls.Add(lvhd);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error creating LuuVetHoatDong: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating LuuVetHoatDong: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicKiemSoatOrderForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Kiểm soát order",
                Size = new Size(1040, 600),
                BackColor = System.Drawing.Color.White,
                StartPosition = FormStartPosition.CenterScreen,
                WindowState = FormWindowState.Normal
            ...
            try
            {
                No1Run.KiemSoatOrder kso = new No1Run.KiemSoatOrder();
                kso.Dock = DockStyle.Fill;
                form.Controls.Add(kso);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error creating KiemSoatOrder: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating KiemSoatOrder: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicDanhSachBillHuyForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Danh mục hóa đơn hủy",
                Size = new Size(1040, 600),
                BackColor = System.Drawing.Color.White,
                StartPosition = FormStartPosition.CenterScreen,
                WindowState = FormWindowState.Normal
            ...
            try
            {
                No1Run.DanhSachBillHuy bh = new No1Run.DanhSachBillHuy();
                bh.Dock = DockStyle.Fill;
                form.Controls.Add(bh);
            }
            catch (Exception ex)
            {
                Console.WriteLine("Error creating DanhSachBillHuy: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating DanhSachBillHuy: " + ex.Message);
            }

            return form;
        }

        private static Form CreateDynamicKhachHangThanThietForm(FormModel model)
        {
            Form form = new Form
            {
                Text = model != null && !string.IsNullOrEmpty(model.Name) ? model.Name : "Khách hàng thân thiết",
                Size = new Size(1040, 600),
                BackColor = System.Drawing.Color.White,
                StartPosition = FormStartPosition.CenterScreen,
                WindowState = FormWindowState.Normal
            ...
            try
            {
                No1Run.KhachHangThanThiet khtt = new No1Run.KhachHangThanThiet();
                khtt.Dock = DockStyle.Fill;
                form.Controls.Add(khtt);
                form.Load += (s, e) => {
                    try { khtt.tvNhom.LoadData(); } catch { }
                };
                form.Shown += (s, e) => {
                    try { khtt.tvNhom.LoadData(); } catch { }
                };
            ...
            {
                Console.WriteLine("Error creating KhachHangThanThiet: " + ex.ToString());
                System.Diagnostics.Debug.WriteLine("Error creating KhachHangThanThiet: " + ex.Message);
            }
